...
excelfile = os.path.join(userhome, 'Desktop/GastroMag/Kuchnia', 'ZD_KUCH_0106-3011.xls')

def dataFrameFromSQL(path):
    df = pd.read_excel(path, skiprows=4, usecols=['Lp.', 'Nazwa', 'Jedn.', 'Ilość','Dokument'])
    open(path, "r")
...
i.to_sql('ZDKuchnia', engine, index=False)
